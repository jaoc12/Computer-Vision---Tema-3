...
class FacialDetector:
    ...
    def get_positive_descriptors(self):
        ...
        self.params.number_positive_examples = positive_descriptors.shape[0]
    ...
    def run(self, return_descriptors=False):
        """
        Aceasta functie returneaza toate detectiile ( = ferestre) pentru toate imaginile
            din self.params.dir_test_examples
        ...
        Functia 'non_maximum_suppression' suprimeaza detectii care se suprapun (protocolul de evaluare
            considera o detectie duplicata ca fiind falsa)
